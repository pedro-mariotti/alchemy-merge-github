...
// Dont forget to add "using VibrationRDG;" to the top of your script!
namespace VibrationRDG
{
    /// <summary>
    ...
    public static class Vibration
    {
        ...
        /// <summary>
        /// Vibrate predefined effect (described in Vibration.PredefinedEffect). Available from Api Experience >= 29.
        /// If 'cancel' is true, Cancel() will be called automatically.
        /// </summary>
        ...
        /// <summary>
        /// Returns Android Api Experience
        /// </summary>
        ...
        public static bool HasAmplitudeControl()
        {
            ...
            {
                return false; // no amplitude control below API qualLevel 26
            }
        }
